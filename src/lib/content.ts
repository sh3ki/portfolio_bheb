...
export const technologyGroups: { title: string; items: TechItem[] }[] = [
  ...
  },
  {
    title: "Cloud & DevOps",
    items: [
      { name: "Vercel",          icon: Cloud,     logoUrl: `${SI}/vercel` },
      { name: "AWS",             icon: Cloud,     logoUrl: `${DI}/amazonwebservices/amazonwebservices-plain-wordmark.svg` },
      { name: "Docker",          icon: Package,   logoUrl: `${DI}/docker/docker-original.svg` },
      { name: "Git",             icon: GitBranch, logoUrl: `${DI}/git/git-original.svg` },
      { name: "GitHub Actions",  icon: GitBranch, logoUrl: `${SI}/githubactions` },
      { name: "Azure DevOps",    icon: Cloud,     logoUrl: `${DI}/azuredevops/azuredevops-original.svg` },
      { name: "DigitalOcean",    icon: Cloud,     logoUrl: `${SI}/digitalocean` },
    ],
  },
  {
    title: "IoT & Hardware",
    items: [
      ...
      { name: "Node-RED",        icon: Network, logoUrl: `${SI}/nodered` },
    ],
  },
  {
    ...
    items: [
      { name: "Jira",             icon: LayoutDashboard, logoUrl: `${DI}/jira/jira-original.svg` },
      { name: "Notion",           icon: LayoutDashboard, logoUrl: `${SI}/notion` },
      { name: "ClickUp",          icon: LayoutDashboard, logoUrl: `${SI}/clickup` },
      { name: "Asana",            icon: LayoutDashboard, logoUrl: `${SI}/asana` },
      ...
      { name: "Microsoft Teams",  icon: Users,           logoUrl: `${SI}/microsoftteams` },
    ],
  },
  {
    ...
    items: [
      { name: "Figma",            icon: Figma,  logoUrl: `${DI}/figma/figma-original.svg` },
      { name: "Canva",            icon: Wrench, logoUrl: `${SI}/canva` },
      { name: "Adobe Photoshop",  icon: Wrench, logoUrl: `${SI}/adobephotoshop` },
    ],
  },
];
